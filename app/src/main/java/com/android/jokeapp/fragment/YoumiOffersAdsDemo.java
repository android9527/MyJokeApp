...
//		addTextToSb(sb, "是否已经开启服务器回调：%b", OffersManager.isUsingServerCallBack());
//		addTextToSb(sb, "是否在通知栏显示下载相关通知：%b", AdManager.isDownloadTipsDisplayOnNotification());
//		addTextToSb(sb, "是否在通知栏显示安装成功的通知：%b",
//				AdManager.isInstallationSuccessTipsDisplayOnNotification());
//		addTextToSb(sb, "是否在通知栏显示积分赚取提示：%b", PointsManager.isEnableEarnPointsNotification());
//		addTextToSb(sb, "是否开启积分赚取的Toast提示：%b", PointsManager.isEnableEarnPointsToastTips());
//
