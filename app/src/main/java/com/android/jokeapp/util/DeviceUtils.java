...
public class DeviceUtils {
	...
	public static void hideSoftInput(Context ctx, View v) {
		if (v != null && ctx != null) {
			...
			// 这个方法可以实现输入法在窗口上切换显示，如果输入法在窗口上已经显示，则隐藏，如果隐藏，则显示输入法到窗口�?			imm.hideSoftInputFromWindow(v.getApplicationWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
		}
	}
	...
	/** 
	 * 获取外置的sdcard列表
	 * 参�?：http://blog.csdn.net/boystarzq09/article/details/9837535
	 * */
